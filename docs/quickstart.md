...
这页给第一次使用 dLazy PPT 的人看。你只需要准备一份文章、报告、大纲、论文或课程笔记，然后让 agent 使用 `dlazy-ppt` skill 生成 PPT。
...
```text
请使用 dlazy-ppt skill，把 /path/to/article.md 做成 10 页左右的中文 PPT。
```

如果你已经知道风格和用途，可以写得更具体：

```text
请使用 dlazy-ppt skill，把这篇技术文章做成 12 页中文分享 PPT。风格偏清爽专业，适合内部技术分享；第 5 页必须使用我提供的架构图，第 8 页必须保留实验结果图。
```
