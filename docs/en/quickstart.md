...
This page is for first-time dLazy PPT users. All you need is an article, report, outline, paper, or set of course notes. Then ask your agent to use the `dlazy-ppt` skill to generate a presentation.
...
```text
Please use the dlazy-ppt skill to turn /path/to/article.md into a Chinese presentation of about 10 slides.
```

If you already know the intended style and use case, be more specific:

```text
Please use the dlazy-ppt skill to turn this technical article into a 12-slide Chinese presentation. Use a clean, professional style suitable for an internal technical talk. Slide 5 must use the architecture diagram I provided, and slide 8 must preserve the experiment results figure.
```
