#!/usr/bin/env python3
"""Remove a solid chroma-key background from a dlazy-ppt slide image.

This helper supports the transparent-asset workflow: generate an
...
def _dependency_hint(package: str) -> str:
    home = Path(os.getenv("DLAZY_PPT_HOME", DEFAULT_RUNTIME_HOME)).expanduser()
    if os.name == "nt":
    ...
    return (
        ...
        f"`python3 {skill_root / 'scripts' / 'dlazy_ppt_runtime.py'} bootstrap`, "
